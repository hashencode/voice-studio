...
from tool.validate_meeting_intelligence_provider_contract import (
    ContractError,
...
class MeetingIntelligenceProviderContractTest(unittest.TestCase):
    ...
    def test_unsupported_capability_fails(self) -> None:
        offer = copy.deepcopy(self.offer)
        offer["capabilities"].append("meeting_intelligence.anything.v9")
