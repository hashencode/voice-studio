...
class MeetingShareReceipt {
  const MeetingShareReceipt({required this.exportPath, required this.readOnly});
...
class MeetingShareService {
  ...
  Future<MeetingShareReceipt> share({
    ...
    try {
      ...
      return MeetingShareReceipt(exportPath: exportPath, readOnly: true);
    } catch (error) {
