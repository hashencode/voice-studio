# Meeting Intelligence Provider Protocol v1
...
- retain no meeting transcript after the mobile-declared job retention window
...
- Protocol schema: `meeting_intelligence_provider/v1`.
- Result schema: `meeting_intelligence_output/v1`, identical to the app-owned
  DeepSeek adapter output contract.
- Processing locations: `onDevice`, `cloudDirect`, `pairedPc`. This protocol
  requires `pairedPc`.
- Required capability: `meeting_intelligence.generate.v1`.
- Optional capabilities:
  `meeting_intelligence.progress.v1`,
  `meeting_intelligence.cancel.v1`,
  `meeting_intelligence.retry.v1`.
...
4. Mobile obtains the same per-meeting explicit consent used by cloud direct,
...
6. PC returns `jobResult` with the original job/idempotency/input identities and
   a strict `meeting_intelligence_output/v1` object. Mobile validates both
...
```json
{
  "schemaVersion": "meeting_intelligence_provider/v1",
  "messageType": "pairingOffer",
  "protocolVersion": 1,
  "sessionId": "018f3da0-90e7-7d31-a912-4b75d4f05521",
  "endpoint": "wss://pc.example.invalid/meeting-intelligence/v1",
  ...
  "capabilities": [
    "meeting_intelligence.generate.v1",
    "meeting_intelligence.progress.v1",
    "meeting_intelligence.cancel.v1"
  ],
...
```json
{
  "schema_version": "meeting_intelligence_input/v1",
  "template_id": "general",
  "input_start_ms": 0,
  "input_end_ms": 120000,
  "segments": [
...
[`meeting-intelligence-provider-v1.schema.json`](../contracts/meeting-intelligence-provider-v1.schema.json).
