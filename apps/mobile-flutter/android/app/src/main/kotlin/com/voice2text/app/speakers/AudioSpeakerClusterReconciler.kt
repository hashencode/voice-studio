...
internal data class AudioSpeakerAssignment(
    val localSpeakerIndex: Int,
...
internal class AudioSpeakerClusterReconciler(
    ...
    init {
        ...
        require(maximumSpeakerCount > 0) { "音频级说话人上限必须为正数" }
    }
    ...
    fun reconcile(
    ...
    ): List<AudioSpeakerAssignment> {
        check(!closed) { "音频级说话人 reconciler 已关闭" }
        require(
        ...
        val assignments = mutableListOf<AudioSpeakerAssignment>()
