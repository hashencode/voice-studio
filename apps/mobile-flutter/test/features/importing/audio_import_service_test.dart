...
void main() {
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        .setMockMethodCallHandler(channel, (call) async {
          ...
          return <String, Object?>{
            'path': '/data/user/0/app/files/audios/imports/complete/a.m4a',
            'displayName': '音频.m4a',
            'mimeType': 'audio/mp4',
            'sizeBytes': 4096,
            'durationMs': 12_000,
  ...
  test('duplicate fingerprint discards a newly copied alternate path', () async {
    ...
    final existing = await repository.insertImported(
      filePath: '/data/user/0/app/files/audios/imports/complete/original.m4a',
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        .setMockMethodCallHandler(channel, (call) async {
          ...
          return <String, Object?>{
            'path':
                '/data/user/0/app/files/audios/imports/complete/alternate.mp4',
  ...
  test('cancel requests native copy cancellation', () async {
    ...
    final service = AudioImportService(channel: channel);

    await service.cancelImport();

    expect(captured?.method, 'cancelAudioImport');
  });
    ...
    () async {
      ...
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(channel, (call) async {
            ...
            return <String, Object?>{
              'path':
                  '/data/user/0/app/files/audios/imports/complete/shared.m4a',
      ...
      expect(captured?.method, 'consumeSharedAudioMedia');
      ...
      await TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .handlePlatformMessage(
            ...
            const StandardMethodCodec().encodeMethodCall(
              const MethodCall('sharedAudioMediaAvailable'),
            ),
            (_) {},
          );
