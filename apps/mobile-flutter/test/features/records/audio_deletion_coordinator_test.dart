...
void main() {
  test(
    ...
    () async {
      ...
      await repository.registerOwnedAsset(
        ...
        path: '/data/user/0/app/files/audios/exports/media.m4a',
        kind: 'share_export',
      );
      final fileStore = _RetryFileStore(
        failingPath: '/data/user/0/app/files/audios/exports/media.m4a',
      );
      final coordinator = AudioDeletionCoordinator(
  ...
  test(
    ...
    () async {
      ...
      const recordingPath =
          '/data/user/0/app/files/audios/recordings/complete/session.m4a';
      const stagingPath =
          '/data/user/0/app/files/audios/recordings/in-progress/'
          'session.m4a.partial';
      const journalPath =
          '/data/user/0/app/files/audios/journals/'
...
class _TrackingFileStore implements AudioFileStore {
