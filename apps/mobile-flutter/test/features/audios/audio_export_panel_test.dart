...
import 'package:voice2text_flutter/features/audios/widgets/audio_export_panel.dart';
...
void main() {
  testWidgets('selects VTT and a validated range with preview count', (
      ...
      MaterialApp(
        home: Builder(
          builder: (context) => Scaffold(
            body: TextButton(
              onPressed: () async {
                result = await showAudioExportPanel(
                  context,
                  durationMs: 10000,
    ...
    await tester.pumpAndSettle();
    expect(result?.format, AudioExportFormat.vtt);
