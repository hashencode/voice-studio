class AudioTimeRange {
  AudioTimeRange({
    ...
    if (durationMs <= 0) {
      throw ArgumentError.value(durationMs, 'durationMs', '音频时长必须大于 0');
    }
    if (startMs < 0) {
    ...
    if (endMs > durationMs) {
      throw ArgumentError.value(endMs, 'endMs', '结束时间不能超过音频时长');
    }
  }

  factory AudioTimeRange.full(int durationMs) {
  ...
  bool operator ==(Object other) {
    return other is AudioTimeRange &&
