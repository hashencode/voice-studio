...
enum AudioIntelligenceJobStatus {
  queued,
  processing,
  completed,
  failed,
  ...
  static AudioIntelligenceJobStatus fromStorage(Object? value) {
    return AudioIntelligenceJobStatus.values.firstWhere(
      (status) => status.name == value,
      orElse: () => AudioIntelligenceJobStatus.failed,
    );
  }
}

class AudioIntelligenceJobEntity {
  const AudioIntelligenceJobEntity({
    required this.id,
  ...
  factory AudioIntelligenceJobEntity.fromMap(Map<String, Object?> map) {
    return AudioIntelligenceJobEntity(
      id: map['id'] as int,
      recordingId: map['recording_id'] as int,
      generationId: map['generation_id'] as int,
      providerId: map['provider_id'] as String,
      modelId: map['model_id'] as String,
      processingLocation: AudioProcessingLocation.fromStorage(
        map['processing_location'],
      ),
      templateId: map['template_id'] as String? ?? 'general',
      status: AudioIntelligenceJobStatus.fromStorage(map['status']),
  ...
  final AudioIntelligenceJobStatus status;
